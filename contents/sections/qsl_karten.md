...
Eine Bedeutung haben QSL-Karten für *Amateurfunk-Diplome*. Das sind Auszeichnungen, die ein Funkamateur erhalten kann, wenn er eine bestimmte Anzahl an Funkverbindungen nach bestimmten Vorgaben erreicht hat. Um ein Diplom zu beantragen, muss man die geforderten Funkverbindungen nachweisen können. Heutzutage gibt es dazu elektronische Möglichkeiten. Für viele deutsche Diplome lassen sich die nötigen Nachweise bequem über das [DARC Community Logbuch](https://dcl.darc.de/public/) führen, das allen DARC-Mitgliedern offen steht. Aber auch mit traditionellen QSL-Karten lassen sich Funkverbindungen nachweisen. Damit eine QSL-Karte für Diplome gewertet werden kann, sollte sie die vorgenannten Mindestangaben enthalten. Zusätzlich kann eine QSL-Karte auch weitere Informationen enthalten, beispielsweise zu verwendeten Transceivern oder Antennen. Häufig finden sich auch Hinweise auf Amateurfunkvereinigungen, denen der Funkamateur angehört. Eine Unterschrift der Karte ist seit einigen Jahren nicht mehr notwendig.
